...
export interface ApiAuditLogAuditLog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    AuditLogMeta: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiCandidateProfileCandidateProfile
  ...
  attributes: {
    ...
    primaryResume: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    ...
    resume: Schema.Attribute.Relation<'oneToOne', 'api::resume.resume'>;
    resumeFiles: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    resumeParsed: Schema.Attribute.JSON;
    skills: Schema.Attribute.JSON;
    task_assignments: Schema.Attribute.Relation<
      'oneToMany',
      'api::task-assignment.task-assignment'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<
      ['shared.seo', 'shared.hero', 'shared.media']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHowItWorksSectionHowItWorksSection
  ...
  attributes: {
    ...
    Tabs: Schema.Attribute.Component<'repeatable.how-it-works-tab', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPointsPlanPointsPlan extends Struct.CollectionTypeSchema {
  collectionName: 'points_plans';
  info: {
    displayName: 'Points Plan';
    pluralName: 'points-plans';
    singularName: 'points-plan';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPointsTransactionPointsTransaction
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    relatedResumeView: Schema.Attribute.Relation<
      'oneToOne',
      'api::resume-view.resume-view'
    >;
    type: Schema.Attribute.Enumeration<['Purchase', 'Debit', 'Refund']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiResumeViewResumeView extends Struct.CollectionTypeSchema {
  collectionName: 'resume_views';
  info: {
    displayName: 'Resume View';
    pluralName: 'resume-views';
    singularName: 'resume-view';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    pointsCharged: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    resume: Schema.Attribute.Relation<'oneToOne', 'api::resume.resume'>;
    ResumeViewStatus: Schema.Attribute.Enumeration<['Success', 'Failed']>;
...
export interface ApiResumeResume extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    parsedData: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
    resumeFile: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    resumeStatus: Schema.Attribute.Enumeration<['Active', 'Archived']>;
...
export interface ApiTaskAssignmentTaskAssignment
  extends Struct.CollectionTypeSchema {
  collectionName: 'task_assignments';
  info: {
    displayName: 'Task Assignment';
    pluralName: 'task-assignments';
    singularName: 'task-assignment';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    deliverables: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    description: Schema.Attribute.RichText;
    ...
    TaskAssignmentStatus: Schema.Attribute.Enumeration<
      ['Assigned', 'In Progress', 'Submitted', 'Reviewed', 'Completed']
    >;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::points-plan.points-plan': ApiPointsPlanPointsPlan;
      'api::points-transaction.points-transaction': ApiPointsTransactionPointsTransaction;
      'api::resume-view.resume-view': ApiResumeViewResumeView;
      'api::resume.resume': ApiResumeResume;
      'api::task-assignment.task-assignment': ApiTaskAssignmentTaskAssignment;
